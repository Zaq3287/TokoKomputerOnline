...
Public Class frm_data_karyawan
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        If String.IsNullOrEmpty(txtNama.Text) = False Then
            ...
            If resultDlg = DialogResult.Yes Then
                Dim result As Integer = DeleteKaryawan(txtNama.Text)
    ...
    Private Sub OpenSubForm()
        gbolEdit = False
        Dim subForm As New frm_edit_karyawan
    ...
    Private Sub FindData()
        ...
        strSQL = "SELECT nama FROM tbl_karyawan" &
    ...
    Private Sub setSQL()
        ...
        strSQL = "SELECT nama FROM tbl_karyawan ORDER BY nama"
